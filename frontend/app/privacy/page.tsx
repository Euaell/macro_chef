		...
		<div className="max-w-4xl mx-auto space-y-8">
			...
			<div className="card p-8 prose prose-slate max-w-none">
				...
				<section className="mb-8">
					...
					<p className="text-slate-600 leading-relaxed">When you create an account, we collect:</p>
					...
					<h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">2.2 Health and Nutrition Data</h3>
					<p className="text-slate-600 leading-relaxed">To provide our services, we collect:</p>
					<ul className="list-disc list-inside text-slate-600 space-y-2 ml-4">
					...
					<h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">2.3 Usage Information</h3>
					<p className="text-slate-600 leading-relaxed">We automatically collect:</p>
					<ul className="list-disc list-inside text-slate-600 space-y-2 ml-4">
				...
				<section className="mb-8">
					...
					<div className="mt-4 p-4 bg-slate-50 rounded-lg">
						<p className="text-slate-700"><strong>Email:</strong> privacy@mizan.app</p>
						<p className="text-slate-700 mt-2"><strong>Website:</strong> <a href="https://mizan.app" className="text-brand-600 hover:text-brand-700">mizan.app</a></p>
					</div>
				</section>
			</div>
		</div>
