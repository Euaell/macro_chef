	...
	return (
		<div className="max-w-4xl mx-auto space-y-8">
			...
			<div>
				...
				<h1 className="text-4xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 mb-2">Terms of Service</h1>
			...
			<div className="card p-8 prose prose-slate dark:prose-invert max-w-none">
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">1. Acceptance of Terms</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">2. Description of Service</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
						Mizan is a nutrition tracking and meal planning application that helps users:
					</p>
					<ul className="list-disc list-inside text-charcoal-blue-600 dark:text-charcoal-blue-400 space-y-2 ml-4">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">3. User Accounts and Registration</h2>
					<h3 className="text-xl font-semibold text-charcoal-blue-800 dark:text-charcoal-blue-200 mb-3 mt-6">3.1 Account Creation</h3>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
					...
					<h3 className="text-xl font-semibold text-charcoal-blue-800 dark:text-charcoal-blue-200 mb-3 mt-6">3.2 Eligibility</h3>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">4. Acceptable Use</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">You agree not to:</p>
					<ul className="list-disc list-inside text-charcoal-blue-600 dark:text-charcoal-blue-400 space-y-2 ml-4">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">5. Medical Disclaimer</h2>
					<div className="p-4 bg-amber-50 dark:bg-amber-950 border-l-4 border-amber-500 rounded">
						<p className="text-charcoal-blue-700 dark:text-charcoal-blue-300 leading-relaxed font-semibold mb-2">
					...
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed mt-4">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">6. User Content</h2>
					<h3 className="text-xl font-semibold text-charcoal-blue-800 dark:text-charcoal-blue-200 mb-3 mt-6">6.1 Your Content</h3>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
					...
					<h3 className="text-xl font-semibold text-charcoal-blue-800 dark:text-charcoal-blue-200 mb-3 mt-6">6.2 Content Standards</h3>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">7. Intellectual Property</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">8. Third-Party Services and Links</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">9. Disclaimer of Warranties</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">10. Limitation of Liability</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">11. Indemnification</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">12. Termination</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">13. Governing Law</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">14. Changes to Terms</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-3xl font-semibold tracking-tight text-charcoal-blue-900 dark:text-charcoal-blue-50 sm:text-4xl mb-4">15. Contact Information</h2>
					<p className="text-charcoal-blue-600 dark:text-charcoal-blue-400 leading-relaxed">
						If you have any questions about these Terms, please contact us:
					</p>
					<div className="mt-4 p-4 bg-charcoal-blue-50 dark:bg-charcoal-blue-900 rounded-lg">
						<p className="text-charcoal-blue-700 dark:text-charcoal-blue-300"><strong>Email:</strong> contact@zaftech.co</p>
						<p className="text-charcoal-blue-700 dark:text-charcoal-blue-300 mt-2"><strong>Website:</strong> <a href="https://mizan.euaell.me" className="text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300">mizan.euaell.me</a></p>
					</div>
				</section>
			</div>
		</div>
