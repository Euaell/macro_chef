		...
		<div className="max-w-4xl mx-auto space-y-8">
			...
			<div className="card p-8 prose prose-slate max-w-none">
				...
				<section className="mb-8">
					...
					<h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">3.2 Eligibility</h3>
					<p className="text-slate-600 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-2xl font-bold text-slate-900 mb-4">5. Medical Disclaimer</h2>
				...
				<section className="mb-8">
					...
					<h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">6.1 Your Content</h3>
					<p className="text-slate-600 leading-relaxed">
					...
					<h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">6.2 Content Standards</h3>
					<p className="text-slate-600 leading-relaxed">
				...
				<section className="mb-8">
					<h2 className="text-2xl font-bold text-slate-900 mb-4">8. Third-Party Services and Links</h2>
					<p className="text-slate-600 leading-relaxed">
				...
				<section className="mb-8">
					...
					<div className="mt-4 p-4 bg-slate-50 rounded-lg">
						<p className="text-slate-700"><strong>Email:</strong> legal@mizan.app</p>
