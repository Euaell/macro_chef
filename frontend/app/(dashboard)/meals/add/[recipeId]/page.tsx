	...
	if (!recipe) {
		return (
			<div className="min-h-[50vh] flex flex-col items-center justify-center">
				...
				<h2 className="text-xl font-semibold text-charcoal-blue-900 dark:text-charcoal-blue-100 mb-2">Recipe not found</h2>
				<p className="text-charcoal-blue-500 dark:text-charcoal-blue-400 mb-6">The recipe you&apos;re trying to log doesn&apos;t exist.</p>
		...
		<div className="max-w-3xl mx-auto space-y-6">
			...
			<div className="card p-6 bg-white/70 dark:bg-charcoal-blue-950/60 border-none">
				<div className="flex items-center gap-4 mb-6">
					...
					<div>
						<h2 className="text-lg font-bold text-charcoal-blue-900 dark:text-charcoal-blue-100">{recipe.title}</h2>
						<p className="text-sm text-charcoal-blue-600 dark:text-charcoal-blue-300">Calculated per serving ({recipe.servings} total)</p>
					</div>
				</div>
