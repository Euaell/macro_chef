	...
	return (
		<div className="space-y-6">
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
				<div>
					<h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Manage Recipes</h1>
					<p className="text-slate-500 dark:text-slate-400 mt-1">Browse and moderate community recipes</p>
				</div>
			</div>
					...
					<table className="w-full text-left border-collapse">
						<thead>
							<tr className="border-b border-slate-100 bg-slate-50/50 dark:border-white/10 dark:bg-slate-900/80">
								<th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">Title</th>
								<th className="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">Servings</th>
								<th className="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">Calories</th>
								<th className="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">Protein</th>
								<th className="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-300">Visibility</th>
