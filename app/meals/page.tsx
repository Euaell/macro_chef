...
export default async function Page() {
	...
	return (
		<section className="max-w-4xl mx-auto bg-white/90 rounded-2xl shadow-xl p-8 mt-8 animate-fade-in-up">
			<h1 className="text-2xl font-bold mb-4 text-emerald-800">Your Meals</h1>
